        ...
        <section className="mx-auto max-w-[1200px] px-6 md:px-10 py-12 md:py-16 w-full space-y-12 md:space-y-16">
          ...
          {product.description ? (
            <div className="space-y-4 text-left">
              ...
              <div
                className="max-w-3xl text-[15px] leading-relaxed text-stone-650 font-light md:text-[16px] [&_a]:text-[var(--brand)] [&_a]:underline [&_blockquote]:border-l-2 [&_blockquote]:border-stone-300 [&_blockquote]:pl-4 [&_blockquote]:italic [&_img]:my-4 [&_img]:rounded-sm [&_ol]:list-decimal [&_ol]:pl-5 [&_p]:mb-3 [&_ul]:list-disc [&_ul]:pl-5 [&_img[src*='s.w.org']]:float-left [&_img[src*='s.w.org']]:clear-left [&_img[src*='s.w.org']]:mt-0.5 [&_img[src*='s.w.org']]:mr-1.5 [&_img[src*='s.w.org']]:mb-1 [&_img[src*='s.w.org']]:h-4 [&_img[src*='s.w.org']]:w-4 [&_img[src*='s.w.org']]:rounded-none [&_li:has(p:empty)]:hidden"
