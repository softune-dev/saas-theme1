      ...
      {open ? (
        <div className="fixed inset-0 z-[95] flex items-center justify-center p-4">
          ...
          <motion.div
            ...
            className="relative z-10 grid w-full max-w-3xl grid-cols-1 overflow-hidden border hairline bg-[var(--background)] shadow-2xl sm:grid-cols-2"
          >
            <button
              type="button"
              onClick={close}
              aria-label="Close"
              className="absolute top-3 right-3 z-10 inline-flex size-8 items-center justify-center rounded-full bg-[var(--background)]/90 text-stone-600 shadow-sm transition-colors hover:bg-[var(--background)] hover:text-[var(--foreground)]"
            >
